...
import dumymodel "golang-restfull-api/app/model/dumy"
...
type DataExcel struct {
	...
	Dumy_data   []dumymodel.Dumy `gorm:"foreignKey:Bulan,Tahun;references:Bulan,Tahun" json:"data_dumy"`
	// foreignKey : adalah kolom yang ada di tabel dumy
	// references : adalah kolom yang ada di tabel data_excel
}
